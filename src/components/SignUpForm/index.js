...
export default function SignUpForm(props) {
	const { onRegistration, onClickExchangeEOSHandler, onClickExchangeUSDTHandler, portfolio } = props
	...
	return (
		<>
			<div>
			<div style={{background: '#fff', width: '100%', height: '3.7rem', padding: '1.1rem 2rem', boxShadow: '0 9px 10px 0 rgba(0,0,0,0.11)', fontSize: '1.3rem', fontWeight: 'bold'}}>
				<span style={{color: '#240000'}}>META Lite Wallet</span>
			</div>
			<div className={'createWalletForm'}>
				<div className={'justFlexAndDirect'}>
					<div className={'regForm'}>
						<Button onClick={props.onBackClick} style={{color: '#fdc000', fontSize: '.9rem'}} labelPosition="left" >
							<i className="fal fa-arrow-left" style={{marginRight: '.5rem'}}/>
							<span style={{borderBottom: '1px solid #fdc000', color: '#fdc000'}}>Back</span>
						</Button>
						{stepForm}
					</div>
