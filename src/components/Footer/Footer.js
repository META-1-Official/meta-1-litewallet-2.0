          ...
          <div className="modal-content">
            ...
            <div className={"modal-body"} style={{ textAlign: "center" }}>
              ...
              <p style={{ fontSize: "1rem" }}>
                This website (META1.io) and all META 1 COIN TRUST
      ...
      <div className={styles.container}>
        <div className={styles.mainDiv}>
          <ul>
            <li
              onClick={() => {
                window.open("https://meta1coin.vision");
              }}
            >
              <span>Home</span>
            </li>
            <li
              onClick={() => {
                window.open("https://meta1coin.vision/META1Contact");
              }}
            >
    ...
    return (
        <>
                    ...
                    <div className="modal-content">
                        <div className="modal-header">
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                ...
                                <span>The META1 Coin Digital Wallet can be created and accessed from your meta1coin.vision Dashboard account OR on meta-exchange.io.</span>
                            </div>
                            <button style={{ marginBottom: '3rem' }} type="button" className="btn-close" data-bs-dismiss="modal"
                                aria-label="Close" />
                        </div>
                        <div className={styles.modalBody + " modal-body"}>
                            <h4 style={{ marginLeft: '1.2rem', marginBottom: '1rem' }}>GET STARTED: Create a META Lite Wallet on meta1coin.vision Dashboard</h4>
                            <ol>
                    ...
                    <div className="modal-content">
                        <div className="modal-header" style={{ display: 'block', textAlign: 'center' }}>
                            <button type="button" style={{ margin: '0 0 0 97%' }} className="btn-close" data-bs-dismiss="modal"
                                aria-label="Close" />
                            <h2 style={{ margin: '0', fontSize: '2.5rem', color: '#000' }}>WELCOME TO <span style={{ color: '#FFC000' }}>meta1coin.vision</span></h2>
                            <h3 style={{ fontSize: '1.7rem', fontWeight: '500' }}>By Using The <span style={{ color: '#FFC000' }}>meta1coin.vision</span> Website You Are Agreeing To The <strong style={{ fontWeight: '700' }}>Privacy
                        ...
                        <div className={"modal-body"} style={{ textAlign: 'center' }}>
                            ...
                            <p style={{ fontSize: '1rem' }}>This website (meta1coin.vision) and all META 1 COIN TRUST business are
                            ...
                            <p style={{ fontSize: '1rem' }}>* If you need clarification regarding Private transactions and status, please
                                contact private@meta1coin.vision</p>
            ...
            <div className={styles.container}>
                <div className={styles.mainDiv}>
                    <ul>
                        <li onClick={() => { window.open('https://meta1coin.vision') }}><span>Home</span></li>
                        <li onClick={() => { window.open('https://meta1coin.vision/META1Contact') }}><span>Contact Us</span></li>
                        <li onClick={() => { window.open('https://support.meta1coin.vision') }}><span>Support</span></li>
