        ...
        <>
            ...
            <div className={styles.container}>
                <div className={styles.mainDiv}>
                    <ul>
                        <li onClick={() => {window.open('https://meta1.io')}}><span>Home</span></li>
                        <li onClick={() => {window.open('https://meta1.io/META1Contact')}}><span>Contact Us</span></li>
                        <li onClick={() => {window.open('https://support.meta1.io')}}><span>Support</span></li>
                ...
                <div style={{padding: '.9rem 0 .9rem 3rem', width: '13rem'}}>
                    <span style={{fontSize: '.7rem'}}>Copyright © 2021 META 1</span>
                </div>
            </div>
        </>
    )
