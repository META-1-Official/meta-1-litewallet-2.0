        ...
        <>
            <div className={styles.intro}>
                ...
                <div className={styles.helpBlock}>
                    <span style={{marginBottom: '.5rem'}}><a data-bs-toggle="modal" data-bs-target="#video" style={{cursor: 'pointer'}}>META Wallet Video</a></span>
                    <span><a data-bs-toggle="modal" data-bs-target="#terms" style={{cursor: 'pointer'}}>META Wallet Creation Tips</a></span>
                </div>
            </div>
            <div className={styles.newCrypto}>
                ...
                <div className={styles.newCryptoBlock}>
                    <div className={styles.crypto} onClick={portfolio ? onClickExchangeUSDTHandler : null}>
                    ...
                    <hr/>
                    <div className={styles.crypto} onClick={portfolio ? onClickExchangeEOSHandler : null}>
