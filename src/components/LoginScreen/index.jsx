...
export default function LoginScreen(props) {
    const { error, onSubmit, onSignUpClick, portfolio, onClickExchangeEOSHandler, onClickExchangeUSDTHandler } = props
            ...
            <div className={styles.mainBlockContent}>
                <div className={styles.leftBlockContent}>
                    <div className={styles.createMeta}>
                        <h5><strong>This section provides access to your META Lite Wallet.</strong></h5>
                        <span>If you have not yet created a META wallet, please FIRST review the <a data-bs-toggle="modal" data-bs-target="#terms" style={{cursor: 'pointer', textDecoration: 'underline'}}>META Wallet Creation
...
const ModalWalletInstructions = ({ setOpenModal, openModal }) => {
    return (
        ...
        >
            ...
            <p>
                The META 1 Coin Digital Wallet can be created and accessed from
            ...
            <p>
                1. Click the White ‘Create META Wallet’ button to start the
                process.
                <br />
                2. Fill in your information. Some fields may already be
                auto-filled. Make sure the fields are filled in properly. You
                may need to clear the fields and re-enter correctly.
                <br />
                3. Account Box – Create your wallet name <br />
                Note: the ‘Wallet Account Name’ you choose is visible on the
                meta-exchange.io platform. For optimum security, avoid using
                your name or personal information as a part of your META Wallet
                Account name (do not use an email address or your personal name.
                Your META Wallet Account Name must contain from 4 to 63
                characters and must consist of a combination of lowercase Latin
                letters, dashes, or numbers. (No capital letters, blank spaces,
                @, +, !, nor any other non- number/letter characters except a
                dash)
                <br />
                4. Copy the Generated Password / Passphrase (52 characters) Do
                NOT create your own password. You must use the auto generated
                password and properly paste it into the confirm password field;
                You can click the small clipboard under the ‘generated’ password
                field (lower right side). Be sure to properly record and secure
                both the password ‘KEY’ and account name in a safe location.
                <br />
                5. PASTE password phrase into the confirmation box below.
                <br />
                6. Click Submit
                <br />
                7. Confirm and check off ALL 4 Boxes to acknowledge you
                understand about ‘SAVING the Key in a safe place
                <br />
                8. Click Submit
                <br />
                9. Your wallet will now be created, and it will say it is
                ‘LINKED’ at the top of the page.
            </p>
            <br /> <br />
            <p>
                Once you have set up your wallet correctly, and if you have
                Ready to Claim certificates under the ‘Coin Certificate Tab’
                they will change to Receive and Accept.
            </p>
            <h3>LOADING META 1 COINS INTO YOUR WALLET</h3>
            <p>
                When you are ready to receive your coins, click on the Receive
                and Accept button and confirm you want to accept them into your
                wallet. Look on the META Lite wallet tab to see the newly loaded
                coins.
            </p>
            <br /> <br />
            <p>
            ...
            <p>
                ...
                a complete list). <br />
                CREATE MULTIPLE WALLETS - You can create more than one META
                Wallet. <br />
                First ‘unlink’ your active META Wallet before creating a new
                one. <br />
                - Click the word ‘here’ in the phrase, “To unlink your account,
                click here”, to unlink your wallet. <br />
                Click the ‘Create META Wallet’ button to create an additional
                wallet. <br />
                You can switch from one wallet to another by using the ‘unlink’
                feature and then entering your additional wallet name and
                clicking the ‘Link META Wallet’ button. <br />
                And as a general security measure, always double check that you
                are on an official META 1 website. <br />
                And as a general security measure, always double check that you
                are on an official META 1 website. <br />
            </p>
        </Modal>
