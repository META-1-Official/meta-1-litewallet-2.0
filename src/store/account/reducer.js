...
const accountsReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case types.LOGIN_SUCCESS:
            return {...initialState, loading: false, account: action.payload.accountName, token: action.payload.token, isLogin:true,loginError: false, msg: null, fromSignUp: action.payload.fromSignUp, refreshLoginData: !state.refreshLoginData };
