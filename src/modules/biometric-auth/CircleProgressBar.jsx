  ...
  const animate = (startTimestamp, duration, newValues) => {
    ...
    const animateFrame = (timestamp) => {
      ...
      const interpolated = {
        ...
        radius: interpolate(prevValuesRef.current.radius, newValues.radius, fraction),
        progress: interpolate(prevValuesRef.current.progress, newValues.progress, fraction)
      };
      ...
      const radius1 = Math.max(Math.min(Math.min(width, height) / 2, interpolated.radius), 200);
