  ...
  useImperativeHandle(ref, () => ({
    setPc: (pc) => {
      ...
      setInterval(async () => {
        ...
        const bitrateReceived = 8 * (bytesReceived - lastBytesReceived) / elapsedTime;  // in bits per second
        ...
        stats.forEach(report => {
          if (report.type === 'candidate-pair' && report.state === 'succeeded') {
            ...
            setUpBitrate(typeof report.availableOutgoingBitrate !== "undefined" ? report.availableOutgoingBitrate : 0);
            setDownBitrate(typeof report.availableIncomingBitrate !== "undefined" ? report.availableIncomingBitrate : 0);  // Note: Not all browsers support incoming bitrate
          }
        });
      }, 1000);
    }
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '8px' }}>
        <div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <div style={{ color: getColor(downBitrate), marginLeft: '-3px', marginRight: '7px' }}>
